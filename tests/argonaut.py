...
argo_fields = [
    ...
    (float, 'water', 'downstream flow rate', 'cm/s'),
    (float, 'water', 'lateral flow rate', 'cm/s'),
    (float, 'water', 'depth', 'm'),
    (float, 'water', 'downstream flow rate std error', 'cm/s'),
    (float, 'water', 'lateral flow rate std error', 'cm/s'),
